...
/* const chatMessages = [
  ...
  { role: "assistant", content: "Sure! It's sunny and 28°C in your location." },
...
const Chat = () => {
  ...
  useLayoutEffect(() => {
    if(auth?.isLoggedIn && auth.user) {
      toast.loading("Loading your chats...", { id: "loadchats" });
  ...
  return (
    <Box sx={{ display: "flex", flex: 1, width: "100%", height: "100%", mt: 3, gap: 3, }}>
      ...
      <Box sx={{ display: "flex", flex: { md: 0.8, xs: 1, sm: 1 }, flexDirection: "column", px: 3, }}>
        ...
        <div style={{ width: "100%", borderRadius: 8, backgroundColor: "rgb(17,29,39)", display: "flex", margin: "auto", }}>
          {" "}
